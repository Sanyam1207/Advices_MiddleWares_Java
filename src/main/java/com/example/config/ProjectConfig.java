...
@ComponentScan(basePackages = {"com.example.beans", "com.example.implementation"}) //Bhai ye component bnn jaega beans ka isme @Beans annotation use karne ki jroort ni pdegi
